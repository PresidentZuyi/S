...
local library = loadstring(game:HttpGet(("https://raw.githubusercontent.com/PresidentZuyi/Shh/refs/heads/main/Ifuskididc")))()
...
MakeWindow({
  ...
  Key = {
    ...
    KeyLink = "https://discord.gg/j6CJ9C93", "https://discord.gg/j6CJ9C93",
...
local Paragraph1 = AddParagraph(Main, {"Thank you for buying this script🔥✌️", "CREDIT"})
local Paragraph2 = AddParagraph(Main, {"Thank You For Buying!", "INFO"})
